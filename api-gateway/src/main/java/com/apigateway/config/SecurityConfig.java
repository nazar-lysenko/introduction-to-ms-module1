...
public class SecurityConfig {
    ...
    private static final String[] PROTECTED_APIS = {"/resources/**", "/songs/**", "/storages/**"};
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, PROTECTED_APIS).authenticated()
                        .requestMatchers(PROTECTED_APIS).hasRole(ADMIN_ROLE)
